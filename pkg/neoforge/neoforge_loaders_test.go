...
func TestNeoForgeLoaders(t *testing.T) {
	...
	t.Run("fetch oldestFirst", func(t *testing.T) {
		var err error
		oldestFirst, err = neoforge.Loaders(testVersion, false)
		if err != nil {
	...
	t.Run("invalid version", func(t *testing.T) {
		_, err := neoforge.Loaders("invalid version", true)
		if err == nil {
